...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:cadetblue;">
    <a class="navbar-brand" href="#">CRM/Admin/Show Customer</a>
				...
				<tbody>
                					...
                					<c:forEach var="customer" items="${listCustomer}">
                						...
                						<tr>
                							...
                							<td><a href="CustomerEditServlet?id=<c:out value='${customer.id}' />">Edit</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="CustomerDeleteServlet?id=<c:out value='${customer.id}'/>">Delete</a></td>
